package cn.atsoft.dasheng.stockLog.model.params;
...
@Data
@ApiModel
public class RestStockLogParam implements Serializable, BaseValidatingParam {

    private static final long serialVersionUID = 1L;

    private List<RestStockLogDetail> stockLogDetails;

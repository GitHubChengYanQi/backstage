 ...
 */
@RestController
@RequestMapping("/productionPickListsCart/{version}")
@Api(tags = "领料单详情表")
@ApiVersion("2.0")
public class RestProductionPickListsCartController extends BaseController {
...
//    @ApiOperation("新增")
//    @Permission
//    public ResponseData addItem(@RequestBody RestOutStockCartParam productionPickListsCartParam) {

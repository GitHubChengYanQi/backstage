package cn.atsoft.dasheng.goods.spu.model.params;
...
@Data
@ApiModel
public class RestSpuParam extends AbstractDictMap implements Serializable, BaseValidatingParam {
    ...
    private RestCategoryParam spuClassification;
//    private List<ItemAttributeParam> spuAttributes;
    ...
    private List<RestSpuAttribute> spuRequests;
    /**
     * 物品Id
     */

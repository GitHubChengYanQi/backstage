...
//            List<RestAttribute> itemAttributes = detail.getCategoryId() == null ? new ArrayList<>() : itemAttributeService.lambdaQuery()
//                    .in(RestAttribute::getCategoryId, detail.getCategoryId())
//                    .list();

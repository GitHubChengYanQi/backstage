...
-- ----------------------------
INSERT INTO `sys_operation_log` VALUES (1240625204678406146, '业务日志', '配置权限', 1, 'RoleController', 'setAuthority', '2020-03-19 21:04:33', '成功', '角色名称=超级管理员,资源名称=系统管理,用户管理,添加用户,修改用户,删除用户,重置密码,冻结用户,解除冻结用户,分配角色,分配角色跳转,编辑用户跳转,用户列表,角色管理,添加角色,修改角色,删除角色,配置权限,修改角色跳转,角色分配跳转,角色列表,菜单管理,添加菜单,修改菜单,删除菜单,菜单编辑跳转,菜单列表,业务日志,清空日志,日志列表,日志详情,监控管理,部门管理,添加部门,修改部门,删除部门,修改部门跳转,部门列表,部门详情,字典管理,添加字典,修改字典,删除字典,修改菜单跳转,字典列表,字典详情,登录日志,清空登录日志,登录日志列表,通知管理,添加通知,修改通知,删除通知,职位管理,职位表添加,职位表修改,职位表删除,开发管理,接口文档,代码生成,参数配置,参数配置添加,参数配置修改,参数配置删除,主控面板,消息通知,项目介绍,统计报表,系统监控,高级组件,高级表单,文档预览,数据容器,excel处理,excel导入,excel导出,模板配置');
INSERT INTO `sys_operation_log` VALUES (1240625232142708737, '业务日志', '删除菜单', 1, 'MenuController', 'remove', '2020-03-19 21:04:40', '成功', '菜单名称=在线办公');
INSERT INTO `sys_operation_log` VALUES (1240625246839549953, '业务日志', '删除菜单', 1, 'MenuController', 'remove', '2020-03-19 21:04:43', '成功', '菜单名称=国际化');
INSERT INTO `sys_operation_log` VALUES (1240625258407440385, '业务日志', '删除菜单', 1, 'MenuController', 'remove', '2020-03-19 21:04:46', '成功', '菜单名称=租户管理');

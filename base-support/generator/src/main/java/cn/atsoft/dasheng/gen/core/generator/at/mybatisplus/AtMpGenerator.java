 ...
 */
public class AtMpGenerator extends AbstractMpGenerator {
    ...
    protected void beforeGeneration() {
        ...
        if (!this.mpContextParam.getGeneratorInterface()) {
            ...
            templateConfig.setService("/atTemplates/service.java.vm");
            templateConfig.setServiceImpl("/atTemplates/serviceImpl.java.vm");
        }

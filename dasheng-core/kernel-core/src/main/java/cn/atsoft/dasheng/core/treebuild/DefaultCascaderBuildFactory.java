...
import cn.atsoft.dasheng.portal.banner.model.tree.Cascader;
import lombok.Data;
 ...
 */
@Data
public class DefaultCascaderBuildFactory<T extends Cascader> extends AbstractTreeBuildFactory<T> {

 ...
 * @since 2021-11-10
 */
public interface ActivitiProcessLogV1Service extends IService<ActivitiProcessLog> {
...
//    void audit(Long taskId, Integer status, String type, Integer auto);
    ...
    void  checkAction(Long id, String formType, String actionType, Long loginUserId);


    void checkLogActionComplete(Long taskId, Long stepId, String actionType, Long loginUserId);
    ...
    List<ActivitiProcessLog> getAudit3(Long taskId);

    List<ActivitiProcessLog> getAudit1(Long taskId);

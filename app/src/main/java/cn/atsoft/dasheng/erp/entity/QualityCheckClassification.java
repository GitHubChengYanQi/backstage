 ...
 * @since 2021-10-27
 */
@TableName("daoxin_erp_quality_check_classification")
public class QualityCheckClassification implements Serializable {
     ...
     * 质检分类id
     */
      @TableId(value = "quality_check_classification_id", type = IdType.ID_WORKER)
    ...
    public String toString() {
        return "QualityCheckClassification{" +

 ...
 * @since 2022-08-11
 */
@TableName("daoxin_erp_instock_receipt")
public class InstockReceipt implements Serializable {
     ...
     * 物品编号
     */
      @TableId(value = "receipt_id", type = IdType.ID_WORKER)

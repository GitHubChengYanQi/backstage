...
public class AnomalyOrderServiceImpl extends ServiceImpl<AnomalyOrderMapper, AnomalyOrder> implements AnomalyOrderService {
     ...
     */
    @Override
    public void inStock(List<AnomalyResult> anomalyResults) {
...
//            }});
    ...
    public AnomalyOrderResult detail(Long id) {
         ...
         * 返回单据状态
         */
        DocumentsStatusResult detail = statusService.detail(result.getStatus());
        result.setStatusName(detail.getName());
        return result;
    }

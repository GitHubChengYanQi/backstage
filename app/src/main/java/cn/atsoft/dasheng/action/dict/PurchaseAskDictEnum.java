...
public enum PurchaseAskDictEnum {
    ...
    purchaseAskId("purchaseAskId", "采购申请id"), coding("coding", "编号"), type("type", "采购类型"), note("note", "备注"), status("status", "申请状态"), money("money", "总金额"), number("number", "总数量"), typeNumber("typeNumber", "种类数量"), theme("theme", "主题");

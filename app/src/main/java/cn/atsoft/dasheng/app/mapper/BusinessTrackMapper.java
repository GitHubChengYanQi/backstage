...
public interface BusinessTrackMapper extends BaseMapper<BusinessTrack> {
     ...
     * @Date 2021-09-17
     */
    Page<BusinessTrackResult> customPageList(@Param("page") Page page, @Param("paramCondition") BusinessTrackParam paramCondition,@Param("dataScope") DataScope dataScope);
